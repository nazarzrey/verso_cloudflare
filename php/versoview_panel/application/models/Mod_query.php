...
*/
    ...
    function issueMagazine($id_issue) {
      $sintak = "SELECT c.magz_id,a.magz_dtl_id,magz_url AS base_url,issue_id,issue_title,REPLACE(CONCAT(b.gallery_path,'/',b.gallery_image1),'//','/')
    ...
    function subMagazine($base,$url){
     $sintak = "        
      SELECT '$base' as base_url,issue_id,issue_title,REPLACE(CONCAT(b.gallery_path,'/',b.gallery_image1),'//','/') AS gambar,issue_desc,issue_flipbook as flipbook
      FROM magazine_data_dtl a LEFT JOIN magazine_gallery b ON a.issue_cover=b.gallery_id
