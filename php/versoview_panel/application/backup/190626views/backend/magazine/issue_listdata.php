<?php 
    if($submagazine){
        ...
        if($datamagazine->magz_fk_issue==0){
			...
			$href  = base_url("pageturner/".$datamagazine->magz_url."/index.html");
                      ...
                      <div class="col-lg-12 row">
                          ...
                          <div class="col-md-8 text-left">
                              ...
                              <div style="position: absolute;right:0;top:0;min-height: 70px;width: 100px" class="btn-magz">							  
                                <?php 
                                if($conv==2){
                                  echo '<a href="'.$href.'" target="_blank" class=" w100" ><button class="ver-bg3 w100">Pageturner</button></a>';
                                }
                                ?>
                            ...
                            <div class="btn-magz btn-magz-bottom" style="float:right;">
                            ...
                            <div class="btn-publish" style="float:left">                              
                                <?php  if($conv==0){
                                  echo '<button class="w100 ver-bg4 ver-clr1" id="convert-magazine" magz-id="'.$mid.'">Now Publish<br/>Your Magazine</button>';
                                 /*}else{
                                  echo '<button class="w100 ver-clr1">Already Convert</button>';
								 */
                                }
                                ?>
                            </div>
