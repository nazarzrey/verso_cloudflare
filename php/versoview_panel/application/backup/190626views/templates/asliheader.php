    ...
    <div class="container">
      <div class="navbar-collapse" id="myNavbar" style="position: relative;">
        <div style="padding:20px 0;float: left">
          ...
          <a class="mouse" href="<?= base_url('index.php') ?>"><img src="<?= base_url('assets/images/logo.png'); ?>" alt="" style="padding: 5px 0 0 10px;"></a>
        </div>
        <div class="navbar-menu">
          <ul class="nav navbar-nav navbar-right" style="margin-right: 0">
            ...
            <li><a href="<?= base_url('backend/login.html'); ?>">LOGIN</a></li>
            <li><a href="<?= base_url('backend/signup.html'); ?>" class="aktif">SIGN UP</a></li>
          </ul>
      </div>
      </div>
    </div>
    <div class="cover-page">
      <div class="left-menu">
        <div class="header-left-menu">
          <ul>
              <li class="logo-left-menu"><img src="<?= base_url('assets/images/close.png'); ?>" class="xclose"><img src="<?= base_url('assets/images/logo.png'); ?>"></li>
              ...
              <li><label style="margin-left:22px;"></label>
                  <a href="<?= base_url('backend/login.html'); ?>" style="font-size:16px;text-decoration: underline;">Login</a> 
                  / 
                  <a href="<?= base_url('backend/signup.html'); ?>" style="font-size:16px;text-decoration: underline;">Sign Up</a> 
              </li>
          </ul>
        </div>
