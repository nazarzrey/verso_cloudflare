            ...
            <div class="menu-sidebar2__content js-scrollbar1">
                <nav class="navbar-sidebar2">
                    <ul class="list-unstyled navbar__list">
                        <li class="has-sub">
                            <a href="<?= admin_url("") ?>">
                                <i class="fas fa-copy"></i>My Magazines
                            <!-- <span class="inbox-num">3</span> -->
                            </a>
                        </li>
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-user"></i>OpenView
                            </a>
                        </li>
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-user"></i>BAT & Google Rewards
                            </a>
                        </li>
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="<?= base_url("account") ?>"><i class="fas fa-sign-in-alt"></i>Profile</a>
                                </li>
                                <li>
