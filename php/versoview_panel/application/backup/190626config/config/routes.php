...
$route['home']  				= 'home/blank'; #un remark before publish
...
$route['admin/magz/(:any)'] 	= 'backend/magz/$1'; 
$route['admin/magz/(:any)/(:any)'] 	= 'backend/magz/$1/$2'; 
$route['admin/magz/(:any)/(:any)/setting'] 	= 'backend/magz/$1/$2/setting'; 
...
#ajax
$route['xhr/(:any)'] 			= 'ajaxrequest/$1'; #case sensitif lower
$route['xhr/(:any)/(:any)'] 	= 'ajaxrequest/$1/$2'; #case sensitif lower
$route['xhr/api/(:any)'] 	    = 'ajaxrequest/api_magz/$2'; #case sensitif lower
