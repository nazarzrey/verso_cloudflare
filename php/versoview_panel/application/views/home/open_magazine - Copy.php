<?php 
	if($submagazine){
		...
		if($datamagazine->magz_fk_id==0){
		#var_dump($datamagazine);
	...
	#echo h3($flip);
?>
<div class=""  style="background:#f5f5f5;padding-top:100px;">
  <div id="detail-show">
    <div class="container">
      <div class="text-left"><?= $url ?></b></div>
    	<div style="margin:20px 0 !important;overflow: auto">
	    	...
	    	<div class="col-md-6 text-left">
	    		...
	    		<p>
	    			...
	    			<a><img src="<?= base_url('assets/images/facebook.png') ?>"></a>
	    			<a><img src="<?= base_url('assets/images/twitter.png') ?>"></a>
	    			<a><img src="<?= base_url('assets/images/pinterest.png') ?>"></a>
	    			<a><img src="<?= base_url('assets/images/google_plus.png') ?>"></a>
	    		</p>
			    <div class="other-edition row text-center">
			    	<?= $flipbook ?>
				</div>
	    	</div>
	    </div>
...
<div style="background: #fff">
    <div class="container section-magazine-list" >
      <div class="text-left">OTHER ISSUES OF <b><?= $datamagazine->magz_name; ?> MAGAZINE</b></div><br/>
      <?php
     # var_dump($lastmagazine);
	      foreach ($lastmagazine as $result) {
		      ...
		      $url = $result->issue_id;
	      		echo '
		      <a class="col-20" href='.base_url("magz/".$base."/".$url).'>
