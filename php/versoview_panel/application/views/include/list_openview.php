...
.ipro_flip{display: block;background: #0f1627 !important}*/
        ?>
          <a target="_blank" class="<?= $grid ?> i_gallery  p_hide  photo_dtl cover-tengah <?= $cpub ?> brdgr" data-toggle="modal" data-target="#edit-ov" data-magz="<?= $url ?>" data-page="<?= $pge ?>">
            <div class="">
