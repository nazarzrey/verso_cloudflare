      ...
      <div class="ov-footer" style="background: #fff;position: fixed;bottom: 0;left:0;z-index: 999;width:100%;box-shadow:1px 1px 5px #ccc;">
         ...
         <a src="" id="" class="ov-logo pull-left">
         ...
         <!-- <img src="<?=$msturi?>files/extfile/like-ok.png" class="ok"> -->
         </a>
         <a src="" id="ov-comment" class="ov-cmnt hide">
         <img src="<?=$msturi?>files/extfile/comment.png">
         </a>
         <a src="" id="ov-bookmark" class="ov-bookmark ">
         <img src="<?=$msturi?>files/extfile/bookmark.png" class="no">
         <!-- <img src="<?=$msturi?>files/extfile/bookmark-ok.png" class="ok"> -->
         </a>';
          }
